      ...
      <div className="header p-6 border-b border-[#f0eff5] dark:border-[#36404a] transition-colors duration-[350ms] text-[#495057] dark:text-[#e1e9f1] text-[15px] leading-[22.5px] flex justify-between tablet:py-4 tablet:px-1.5">
         ...
         <div className="flex items-center gap-3.5 w-full">
            ...
            <div className="flex flex-col w-full">
               ...
               <span className={`text-sm w-full text-green-500 ${!chatUser?.isActive.status && "!text-[#7a7f9a] dark:text-[#abb4d2]"}`}>
         ...
         {/* right icons */}
         <div className="text-xl text-[#7a7f9a] dark:text-[#abb4d2] transition-colors duration-[350ms] text-center flex items-end gap-2">
