...
const Profile = () => {
   ...
   return (
      <div className="profile py-6 px-7">
         {/* my profile */}
         ...
         <div className="text-[#495057] leading-[22.5px] my-6">
            <div className="flex justify-between items-start text-[#7a7f9a] dark:text-[#9aa1b9] text-[15px] mb-6 gap-0.5 transition-colors duration-300">
